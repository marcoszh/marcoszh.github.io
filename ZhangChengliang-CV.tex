...
{Yinghao Yu}, \uline{Chengliang Zhang}, {Wei Wang}, {Jun Zhang}, {Khaled Letaief}, ``\href{https://marcoszh.github.io/publication/spec-sync/}{Towards Dependency-Aware Cache Management for Data Analytics Applications},'' in the {\em IEEE Transactions on Cloud Computing}.\\

\textbf{Preprints}\\

\uline{Chengliang Zhang}, {Minchen Yu}, {Wei Wang}, Feng Yan, ``Enabling Cost-Effective, SLO-Aware Machine Learning Inference Serving on Public Cloud,'' submitted to {\em IEEE Transactions on Cloud Computing}, under minor revision.\\
